...
const inputClass =
  "mt-2 w-full rounded-md border border-white/10 bg-[#09090b] px-4 py-3 text-sm text-white placeholder:text-[#8d90a2] focus:border-[#2e62ff] focus:outline-none";

export default function ContactPage() {
  return (
    <section className="mesh-gradient pt-32 pb-24 lg:pt-40">
      <div className="kf-container grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
        <div>
          ...
          <div className="mt-8 rounded-md border border-white/10 bg-white/[0.03] p-5">
            <p className="kf-mono text-xs uppercase text-[#8d90a2]">Direct email</p>
        ...
        <div className="kf-card p-6 md:p-8">
          <form action="mailto:knowledgefund@gmail.com" method="post" encType="text/plain" className="space-y-6">
            <div className="grid gap-5 sm:grid-cols-2">
              <div>
                <label htmlFor="first-name" className="kf-mono text-xs uppercase text-[#c3c5d8]">
                  First name
                </label>
                <input id="first-name" name="firstName" type="text" required className={inputClass} placeholder="Jane" />
              </div>
              <div>
                <label htmlFor="last-name" className="kf-mono text-xs uppercase text-[#c3c5d8]">
                  Last name
                </label>
            ...
            <div>
              <label htmlFor="email" className="kf-mono text-xs uppercase text-[#c3c5d8]">
                Work email
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="organisation" className="kf-mono text-xs uppercase text-[#c3c5d8]">
                Organisation
              </label>
              <input
                id="organisation"
            ...
            <div>
              <label htmlFor="challenge" className="kf-mono text-xs uppercase text-[#c3c5d8]">
          ...
          <p className="mt-5 text-center text-xs leading-5 text-[#8d90a2]">
